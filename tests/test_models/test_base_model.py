...
class TestBaseModel(unittest.TestCase):
    ...
    def test_3_instantiation(self):
        """Tests all instantiation of BaseModel class."""
    ...
    def test_3_init_no_args(self):
        ...
        with self.assertRaises(TypeError) as e:
            BaseModel.__init__()
        msg = "__init__() missing 1 required positional argumet: 'self'"
    ...
    def test_3_attributes(self):
        """Tests attributes value for instance of a BaseModel cass."""
    ...
    def test_5_save(self):
        """Tests if storage.save() is called from save()."""
        self.resetStorage()
        b = BaseModel()
        b.save()
